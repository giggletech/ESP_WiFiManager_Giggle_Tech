...
const char WM_HTTP_HEAD_START[] PROGMEM = "<!DOCTYPE html><html lang='en'><head><meta name='viewport' content='width=device-width, initial-scale=1, user-scalable=no'/><title>Giggletech WiFi Configuration</title>";

////////////////////////////////////////////////////

const char WM_HTTP_STYLE[] PROGMEM = "<style>body{background-color: #000000;color: #ffffff;font-family: Arial, sans-serif;margin: 0;padding: 20px;}div{padding:2px;font-size:1em;}textarea,input,select{background: #1a1a1a;border-radius: 4px;font: 16px sans-serif;margin: 0;color: #ffffff;border: 1px solid #333;outline: 0;font-size: 14px;padding: 8px;width: 90%}textarea:focus,input:focus,select:focus{border-color: #e3fc02;background: #2a2a2a}.btn a{text-decoration: none}.container{margin: auto;width: 90%}@media(min-width:1200px){.container{margin: auto;width: 30%}}@media(min-width:768px) and (max-width:1200px){.container{margin: auto;width: 50%}}.btn,h2{font-size: 2em;color: #ffffff}h1{font-size: 3em;color: #ffffff}.btn{background: #e3fc02;border-radius: 4px;border: 0;color: #000000;cursor: pointer;display: inline-block;margin: 2px 0;padding: 10px 14px 11px;width: 100%;font-weight: bold;text-transform: uppercase;letter-spacing: 1px}.btn:hover{background: #c7e002}.btn:active,.btn:focus{background: #aac402}label{color: #ffffff;font-weight: bold}label>*{display: inline}form>*{display: block;margin-bottom: 10px}.msg{background: #1a1a1a;border-left: 5px solid #e3fc02;padding: 1.5em;color: #ffffff}.q{float: right;width: 64px;text-align: right;color: #ffffff}.l{background: url('data:image/png;base64,') no-repeat left center;background-size: 1em}input[type='checkbox']{float: left;width: 20px}.table td{padding:.5em;text-align:left;color: #ffffff}.table tbody>:nth-child(2n-1){background:#1a1a1a}.table tbody>:nth-child(2n){background:#2a2a2a}fieldset{border-radius:0.5rem;margin:0px;border: 1px solid #333;background: #1a1a1a;padding: 15px}a{color: #e3fc02;text-decoration: none}a:hover{color: #c7e002;text-decoration: underline}</style>";
